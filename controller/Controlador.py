...
class Controlador:
    ...
    def lista_de_directores(self):
        
        lista = ["Luisa Fernanda Rincon", "Juan Carlos Martinez", "Maria Constanza Pabón", "Gloria Inés Álvarez", "Gerardo M Sarria M", "Luis Eduardo Tobón", "Juan Pablo García", "Frank Martinez", "Carlos Ramirez"]
        return lista
